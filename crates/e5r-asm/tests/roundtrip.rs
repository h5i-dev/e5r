...
//! `e5r disas`, changes a register, and assembles it back; if the unchanged
...
//! than with `e5r-format`, because the loader lives above this crate in the
