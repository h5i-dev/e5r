...
//! what [`r12e_db::anchor::shape_token`] computes: everything about an
...
use r12e_arch::Insn;
use r12e_core::Addr;
use r12e_db::anchor::{addresses, shape_token};
use serde::Serialize;
...
pub fn compare_function(
    ...
    let render = |p: &Program, i: &Insn| r12e_arch::format(&p.object.arch, i, false);
