...
use r12e_core::{Addr, Arch, Error, Result};

use crate::anchor::Fnv;

/// Magic on the first line.
const TAG: &str = "r12e-project";
...
mod tests {
    ...
    fn the_digest_is_platform_fixed() {
        ...
        assert_eq!(digest(b"r12e"), 0x2d0c_d7e3_a80f_6b11);
    }
}
