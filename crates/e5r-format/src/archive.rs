...
use e5r_core::{Caps, Error, Reader, Result};
...
fn gnu_index(
    ...
    let r = Reader::new(data, e5r_core::Endian::Big);
    let mut c = r;
...
fn bsd_endian(data: &[u8], wide: bool) -> Option<e5r_core::Endian> {
    let avail = data.len() as u64;
    for endian in [e5r_core::Endian::Little, e5r_core::Endian::Big] {
