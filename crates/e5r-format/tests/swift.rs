...
use e5r_core::Addr;
use e5r_format::swift::{ContextKind, FieldDescriptorKind, TypeReference};
use e5r_format::{LoadOptions, load, metadata, swift};
...
fn the_accessors_become_hints_and_nothing_else_does() {
    ...
    let mut names: Vec<String> = found
        .hints
        .iter()
        .filter(|h| h.provenance.best == e5r_core::Evidence::SwiftMetadata)
