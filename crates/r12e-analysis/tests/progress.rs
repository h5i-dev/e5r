...
use r12e_analysis::{Options, Session, Stage, Update};
...
/// to the thread pool.
fn watch(object: Object, opts: &Options) -> (r12e_analysis::Program, Vec<Update>) {
...
fn watching_a_run_does_not_change_it() {
    ...
    let plain = r12e_analysis::analyze(b, &opts);
