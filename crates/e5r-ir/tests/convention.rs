...
use e5r_ir::abi::{self, Abi, Named};
use e5r_ir::conv::{self, Convention, Departure, Observed, Purpose};
use e5r_ir::dwreg;
use e5r_ir::lift::{aarch64, x86};
...
fn what_the_callers_say_reaches_the_prototype() {
    ...
    let p = e5r_ir::proto::recover_observed(&f, &abi, &ignored);
    ...
    let alone = e5r_ir::proto::recover(&f, &abi);
