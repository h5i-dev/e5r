...
//!
//! The inverse of `r12e-arch`, and built on top of it rather than beside it.
...
//! of the structure: a line copied from `r12e disas` assembles back to the
//! bytes it came from.
//!
...
//! everywhere else. `r12e patch` needs exactly that and nothing more.
//!
//! ```
